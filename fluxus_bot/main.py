...
def send_about(message):
    msg = bot.send_message(
        ...
        "Бот разработан в рамках подготовки к перформансу\n"
        "в <a href=\"https://vk.com/soundmuseumspb\">Санкт-Петербургском Музее звука:</a>\n"
        "<b>24 июня 2017, 20:00.\nFLUXUS СПб: программа звуковых перформансов</b>\n\n"
        "<b>Приходите!</b>\n\n"
        "Спонтанность можно перенести на новый уровень, "
        "сгенерировав инструкцию к перформансу перед самим перформансом. "
        "В качестве механизма генерации были выбраны простые марковские цепи для слов и символов, \"обученные\" "
        "на оригинальных инструкциях.\n\n"
